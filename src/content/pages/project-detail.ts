...
const dominos: ProjectDetail = {
  ...
  hero: { src: "/images/our-work-2.webp", alt: "Cold room installed at Domino's Pizza Dammam" },
  overview: {
  ...
  client: {
    ...
    logo: "/images/client-dominos.webp",
    blurb:
    ...
    image: { src: "/images/our-work-1.webp", alt: "Domino's Pizza Dammam cold storage" },
  },
  scope: {
    ...
    image: { src: "/images/our-work-1.webp", alt: "Completed cold room interior" },
  },
  steps: {
  ...
  gallery: [
    ...
    { src: "/images/our-work-2.webp", alt: "Cold room ceiling units" },
    { src: "/images/services-cold-rooms.webp", alt: "Cold room panelling" },
    { src: "/images/services-cooling-units.webp", alt: "Refrigeration unit" },
  ],
  services: [
    {
      title: "Cooling Units",
...
const alkharj: ProjectDetail = {
  ...
  client: {
    ...
    logo: "/images/client-alkharj.webp",
    blurb:
