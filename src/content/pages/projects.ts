export const projectsPage = {
  hero: {
    ...
    href: "#request",
    image: { src: "/images/projects-hero.webp", alt: "Asadtech refrigerated fleet on site" },
  },
  filters: ["All Projects", "Cooling Units", "Cooling Rooms", "Tail Lifters", "Spider Cranes"],
  banner: { src: "/images/projects-facility.webp", alt: "Aerial view of the Asadtech facility" },
  request: {
